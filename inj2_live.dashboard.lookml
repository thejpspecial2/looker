- dashboard: inj2_live
  ...
  layout: grid
  rows:
    - elements: [inj2_ios_revenue_live, inj2_android_revenue_live] 
      height: 300      
...
#  filters:
  ...
  elements:
    ...
    - name: inj2_android_revenue_live
      title: INJ2 Android Revenue Live
      type: looker_line
      model: datatank1
      explore: inj2_live_cume_revenue
      dimensions: [inj2_live_cume_revenue.yyyy_mm_dd, inj2_live_cume_revenue.hh_mm]
      ...
      measures: [inj2_live_cume_revenue.cume_revenue]
      filters:
        inj2_live_cume_revenue.platform: Android
      sorts: [inj2_live_cume_revenue.hh_mm, inj2_live_cume_revenue.yyyy_mm_dd]
      limit: '500'
      column_limit: '50'
      query_timezone: America/Los_Angeles
