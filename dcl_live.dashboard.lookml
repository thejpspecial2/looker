- dashboard: dcl_live
  ...
  rows:
    ...
    - elements: [dcl_ios_installs_live, dcl_android_installs_live]
      height: 300
    - elements: [dcl_ios_pct_payers_live, dcl_android_pct_payers_live]
      height: 300  
    - elements: [dcl_ios_payers_live, dcl_android_payers_live]
      height: 300
    - elements: [dcl_ios_payer_dau_live, dcl_android_payer_dau_live]
      height: 300    
...
#  filters:
  ...
  elements:
    ...
    - name: dcl_android_pct_payers_live 
      title: DCL Android Pct Payers Live
      type: looker_line
      model: datatank1
      explore: dcl_live_cume_dau
      dimensions: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
      pivots: [dcl_live_cume_dau.yyyy_mm_dd]
      measures: [dcl_live_cume_dau.cume_pct_purchasers]
      filters:
        dcl_live_cume_dau.platform: Android
      sorts: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
      limit: '500'
    ...
    - name: dcl_ios_pct_payers_live 
      title: DCL iOS Pct Payers Live
      type: looker_line
      model: datatank1
      explore: dcl_live_cume_dau
      dimensions: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
    ...
    - name: dcl_android_payer_dau_live
      title: DCL Android Payer DAU Live
      type: looker_line
      model: datatank1
      explore: dcl_live_cume_dau
      dimensions: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
      pivots: [dcl_live_cume_dau.yyyy_mm_dd]
      measures: [dcl_live_cume_dau.cume_payer_dau]
      filters:
        dcl_live_cume_dau.platform: Android
      sorts: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
      limit: '500'
    ...
    - name: dcl_ios_payer_dau_live
      title: DCL iOS Payer DAU Live
      type: looker_line
      model: datatank1
      explore: dcl_live_cume_dau
      dimensions: [dcl_live_cume_dau.hh_mm, dcl_live_cume_dau.yyyy_mm_dd]
